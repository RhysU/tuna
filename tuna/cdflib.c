    ...
    int* ierr)
{
    ...
    *ierr = 0;
    ...
    if (cdflib_fifdmax1(*a, *b) < 1.e-3 * eps) {
        goto S260;
    }
    ind = 0;
    a0 = *a;
    ...
    x0 = *x;
    y0 = *y;
    if (cdflib_fifdmin1(a0, b0) > 1.0e0) {
        goto S40;
    }
    //
    ...
    y0 = *x;
S10:
    if (b0 < cdflib_fifdmin1(eps, eps * a0)) {
        goto S90;
    }
    if (a0 < cdflib_fifdmin1(eps, eps * b0) && b0 * x0 <= 1.0e0) {
        goto S100;
    }
    if (cdflib_fifdmax1(a0, b0) > 1.0e0) {
        goto S20;
    }
    if (a0 >= cdflib_fifdmin1(0.2e0, b0)) {
        goto S110;
    }
    if (pow(x0, a0) <= 0.9e0) {
        goto S110;
...
S220:
    ...
    //
    pq = *p + *q;
    if (!(fabs(pq - 0.5e0 - 0.5e0) > 3.0e0 * cdflib_dpmpar(K1))) {
        goto S260;
    }
    if (!(pq < 0.0e0)) {
        goto S240;
...
S260:
    ...
    //
    xy = *x + *y;
    if (!(fabs(xy - 0.5e0 - 0.5e0) > 3.0e0 * cdflib_dpmpar(K1))) {
        goto S300;
    }
    if (!(xy < 0.0e0)) {
        goto S280;
...
S280:
    ...
    //
    prompr = *pr + *ompr;
    if (!(fabs(prompr - 0.5e0 - 0.5e0) > 3.0e0 * cdflib_dpmpar(K1))) {
        goto S320;
    }
    if (!(prompr < 0.0e0)) {
        goto S300;
    ...
    double* df)
{
    static const double coef[4][5] = {
        {1.0e0, 1.0e0, 0.0e0, 0.0e0, 0.0e0}, {3.0e0, 16.0e0, 5.0e0, 0.0e0, 0.0e0}, {
            -15.0e0, 17.0e0,
            19.0e0, 3.0e0, 0.0e0
...
S310:
    switch ((int)i99999) {
case 1: goto S10; case 2: goto S20; case 3: goto S90; case 4: goto S130; case 5: goto S200; case 6: goto S270; default: break;
    }
# undef qxmon
}
...
S280:
    switch ((int)i99999) {
    case 1: goto S10; case 2: goto S20; case 3: goto S200;
    default: break;
    }
# undef ftol
}
...
S70:
    ...
    if (fabs(t)*cdflib_dpmpar(K2) <= 1.0001e0) {
        return Xgamm;
    }
    Xgamm = 1.0e0 / t;
    return Xgamm;
...
S120:
    ...
    w = g;
    t = g - w;
    if (w > 0.99999e0 * cdflib_exparg(&K3)) {
        return Xgamm;
    }
    Xgamm = exp(w) * (1.0e0 + t);
    if (*a < 0.0e0) {
