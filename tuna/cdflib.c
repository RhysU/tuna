...
S220:
    ...
    //
    pq = *p + *q;
    if (!(fabs(pq - 0.5e0 - 0.5e0) > 3.0e0 * dpmpar(K1))) {
        goto S260;
    }
    if (!(pq < 0.0e0)) {
        goto S240;
...
S260:
    ...
    //
    xy = *x + *y;
    if (!(fabs(xy - 0.5e0 - 0.5e0) > 3.0e0 * dpmpar(K1))) {
        goto S300;
    }
    if (!(xy < 0.0e0)) {
        goto S280;
...
S280:
    ...
    //
    prompr = *pr + *ompr;
    if (!(fabs(prompr - 0.5e0 - 0.5e0) > 3.0e0 * dpmpar(K1))) {
        goto S320;
    }
    if (!(prompr < 0.0e0)) {
        goto S300;
    ...
    const double* xx)
{
    ...
    //
    xmax1 = ipmpar[K1];
    xmax1 = cdflib_fifdmin1(xmax1, 1.0e0 / dpmpar(K2));
    xsmall = 1.e-9;
    x = *xx;
    aug = 0.0e0;
    if (x >= 0.5e0) {
