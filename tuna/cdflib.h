...
double cdflib_beta_frac ( double *a, double *b, double *x, double *y, double *lambda, double *eps );
void cdflib_beta_grat ( double *a, double *b, double *x, double *y, double *w, double *eps,int *ierr );
void cdflib_beta_inc ( double *a, double *b, double *x, double *y, double *w, double *w1, int *ierr );
...
void cdflib_cdfbet ( int *which, double *p, double *q, double *x, double *y, double *a, double *b, int *status, double *bound );
void cdflib_cdfbin ( int *which, double *p, double *q, double *s, double *xn, double *pr, double *ompr, int *status, double *bound );
void cdflib_cdfchi ( int *which, double *p, double *q, double *x, double *df, int *status, double *bound );
void cdflib_cdfchn ( int *which, double *p, double *q, double *x, double *df, double *pnonc, int *status, double *bound );
void cdflib_cdff ( int *which, double *p, double *q, double *f, double *dfn, double *dfd, int *status, double *bound );
void cdflib_cdffnc ( int *which, double *p, double *q, double *f, double *dfn, double *dfd, double *phonc, int *status, double *bound );
void cdflib_cdfgam ( int *which, double *p, double *q, double *x, double *shape, double *scale, int *status, double *bound );
void cdflib_cdfnbn ( int *which, double *p, double *q, double *s, double *xn, double *pr, double *ompr, int *status, double *bound );
void cdflib_cdfnor ( int *which, double *p, double *q, double *x, double *mean, double *sd, int *status, double *bound );
void cdflib_cdfpoi ( int *which, double *p, double *q, double *s, double *xlam, int *status, double *bound );
void cdflib_cdft ( int *which, double *p, double *q, double *t, double *df, int *status, double *bound );
void cdflib_chi_noncentral_cdf_values ( int *n_data, double *x, double *lambda, int *df, double *cdf );
...
void cdflib_cumfnc ( double *f, double *dfn, double *dfd, double *pnonc, double *cum, double *ccum );
void cdflib_cumgam ( double *x, double *a, double *cum, double *ccum );
void cdflib_cumnbn ( double *s, double *xn, double *pr, double *ompr, double *cum, double *ccum );
...
void cdflib_dinvr ( int *status, double *x, double *fx, unsigned long *qleft, unsigned long *qhi );
double cdflib_dlanor ( double *x );
double cdflib_dpmpar ( int *i );
void cdflib_dstinv ( double *zsmall, double *zbig, double *zabsst, double *zrelst, double *zstpmu, double *zabsto, double *zrelto );
...
void cdflib_dzror ( int *status, double *x, double *fx, double *xlo, double *xhi, unsigned long *qleft, unsigned long *qhi );
void cdflib_E0000 ( int IENTRY, int *status, double *x, double *fx, unsigned long *qleft, unsigned long *qhi, double *zabsst, double *zabsto, double *zbig, double *zrelst, double *zrelto, double *zsmall, double *zstpmu );
void cdflib_E0001 ( int IENTRY, int *status, double *x, double *fx, double *xlo, double *xhi, unsigned long *qleft, unsigned long *qhi, double *zabstl, double *zreltl, double *zxhi, double *zxlo );
...
void cdflib_f_noncentral_cdf_values ( int *n_data, int *a, int *b, double *lambda, double *x, double *fx );
...
void cdflib_gamma_inc_inv ( double *a, double *x, double *x0, double *p, double *q, int *ierr );
...
void cdflib_gamma_rat1 ( double *a, double *x, double *r, double *p, double *q, double *eps );
...
void cdflib_negative_binomial_cdf_values ( int *n_data, int *f, int *s, double *p, double *cdf );
